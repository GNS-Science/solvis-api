...
class TestGeneralTaskRequest(unittest.TestCase):
    ...
    @mock_sns
    @mock.patch('solvis_api.toshi_api.toshi_api.GeneralTask.get_general_task', lambda _self, id: dict(id='id1'))
    def test_get_vanilla(self):
        ...
        data = dict(general_task_id='id1', locations_list_id='NZ', radii_list_id='6')
