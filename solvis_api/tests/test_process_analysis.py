...
#     @mock.patch('solvis_api.process_solution.requests.get', side_effect=[MockResponse(LOCATIONS, 200),MockResponse(RADII[-1], 200)])
#     @mock.patch('solvis_api.process_solution.process_general_task_request')
...
class TestHandleSolutionRequest(unittest.TestCase):
    @mock.patch(
        'solvis_api.process_solution.requests.get',
        side_effect=[MockResponse(LOCATIONS, 200), MockResponse(RADII[-1], 200)],
    )
    @mock.patch('solvis_api.process_solution.process_solution_request')
