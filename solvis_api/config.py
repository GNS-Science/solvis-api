...
def get_secret(secret_name, region_name):
    ...
    # In this sample we only handle the specific exceptions for the 'GetSecretValue' solvis_api.
...
if IS_OFFLINE:
    ...
    SOLVIS_API_URL = os.getenv(
        'NZSHM22_SOLVIS_API_URL', 'https://ly86h01a86.execute-solvis_api.ap-southeast-2.amazonaws.com/dev/'
    )
