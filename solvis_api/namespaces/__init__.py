...
from .locations import location_lists, locations
...
class ErrorPropagatingApi(Api):
    ...
    def error_router(self, original_handler, e):
        print('error_router : %s, url: %s, path: %s err:%s' % (request.endpoint, request.url, request.path, e))
...
# solvis_api.add_namespace(solution_analysis_geojson)
